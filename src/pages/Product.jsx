...
// <div classNameName=" items-center w-[80%] h-[400px] flex gap-5 shadow-md p-2 mb-6 bg-white rounded-md  m-20 ">
//   {singleProduct.images?.map((el) => (
//     <img
//       classNameName="object-cover w-[100px] h-[100px] transition-transform transform )"
//       src={el}
//       key={el.id}
//     />
//   ))}
//   <div />
//   <div classNameName="items-center flex flex-col">
//     <h1 classNameName="text-blue-400">{singleProduct.title}</h1>
//     <h2>
//       <span classNameName="text-blue-400">brand-</span>
//       {singleProduct.brand}
//     </h2>
//     <h3>
//       <span classNameName="text-blue-400">category-</span>
//       {singleProduct.category}
//     </h3>
//     <p>
//       <span classNameName="text-blue-400"> description-</span>
//       {singleProduct.description}
//     </p>
//     <span classNameName="text-red-500">{singleProduct.price}$</span>

//     <span>{singleProduct.raiting}</span>
//     <span>
//       in stock:<span classNameName="text-green-400">{singleProduct.stock}</span>
//     </span>
//     <button classNameName="bg-blue-400 rounded-[20px] w-[140px] text-white">
//       add to cart
//     </button>
//   </div>
// </div>
